        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
          children:<Widget>[
            ...
            Padding(padding: EdgeInsets.only(top: 8), child:
              Text(Localization().getStringEx("panel.membership_request.label.steps.description", 'Share the steps someone will need to take to become a member of your group.'), style: Styles().textStyles.getTextStyle("widget.description.regular.light")),
            ),
          ]),
      ),
    );
